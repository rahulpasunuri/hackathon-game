...
function preload() {
    ...
    game.load.image('starfield', 'assets/bridge.png');
    ...
    game.load.image('smile', 'people/Smiling_Person2.png');
    game.load.image('enemy-green', 'people/Sad_Person2.png');
    game.load.image('enemy-blue', 'people/Crying_Person2.png');
...
function create() {
   ...
   game.time.events.add(1000, launchGreenEnemy); 
    ...
    liPenalty.createMultiple(2, 'penalty-image');
    ...
    game.time.events.add(1000, launchPenalty);
   ...
   game.time.events.add(1000, launchBlueEnemy); 
    ...
    boss.body.maxVelocity.setTo(400, 400);
    boss.dying = false;
    ...
    for (var i =0; i < numEnemiesInWave; i++) {
        ...
        if (enemy) {
            ...
            */
            ...
            //this.body.y.acceleration=100;
            this.body.y.velocity=100;
...
function hitEnemy(enemy, bullet) {
    ...
    if (enemy.health < 5) {
      ...
      if(enemy.damageAmount==40)
      {
        ...
        newEnemy.body.maxVelocity.setTo(400, 400);
...
greenEnemies.add(newEnemy);
      ...
      else
      {
        ...
        sm.body.maxVelocity.setTo(400, 400);
        sm.dying = false;
